    ...
    $.fn.Selectyze = function(opt) {
        ...
        if(this.length)
            return this.each(function() {
                ...
                DivSelect.html('<a href="#" rel="'+optionselected.val()+'" class="selectyzeValue"><span class="selectyzeButton"></span>'+optionselected.text()+'</a>');
                ...
                UlSelect.find('a').click(function(e){
                    e.preventDefault();
                    DivSelect.find('a.selectyzeValue').html('<span class="selectyzeButton"></span>' + $(this).text());
